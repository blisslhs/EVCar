...
public class view5 extends Fragment {
    private static view5 curr = null;
    public static view5 getInstance(){
        if(curr == null){
            curr = new view5();
        }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.view5frag, container, false);
        bus.register(this);
